  ...
  <div class="app-container" ref="appcontainer">
    <el-card class="box-card">
      ...
      <el-table v-loading="loading" border :data="roleList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="朝代" prop="chaodai" align="center" :show-overflow-tooltip="true" width="150" />
        <el-table-column label="生平时间" prop="date_birth" align="center" :show-overflow-tooltip="true" />
      ...
      <el-dialog :title="title" :visible.sync="open"  :width="dialogWidth">
        <el-form ref="form" :model="form" :rules="rules" label-width="80px">
          <el-row>
            ...
            <el-col :span="24">
              <el-form-item label="朝代" prop="chaodai" style="width: 90%">
                <el-input v-model="form.chaodai" placeholder="请输入用户昵称" />
              </el-form-item>
            </el-col>
             <el-col :span="24">
              <el-form-item label="生平日期" prop="date_birth" style="width: 90%">
                <el-input v-model="form.date_birth" placeholder="请输入生平日期" />
              </el-form-item>
            </el-col>
             <!-- <el-col :span="24">
              <el-form-item label="简单介绍" prop="desc" style="width: 90%">
                <el-input v-model="form.desc"  type="textarea" placeholder="请输入作者介绍" />
              </el-form-item>
            </el-col> -->
            <el-col :span="24">
              <el-form-item label="简单介绍" prop="desc" style="width: 90%">
                <Tinymce ref="editor"  v-model="form.desc" :height="200" />
              </el-form-item>
            </el-col>
...
<script>
import { listAuthor, getAuthorInfo, addAuthor, updateAuthor,delAuthor } from '@/api/poetry/author'
...
export default {
 ...
 updated(){
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      listAuthor(this.addDateRange(this.queryParams, this.dateRange)).then(
        response => {
    ...
    handleUpdate(row) {
      ...
      getAuthorInfo(id).then(response => {
        ...
        this.form.id = id
        this.$refs[`editor`].setContent(this.form.desc)
      })
    },
    /** 提交按钮 */
    submitForm: function() {
