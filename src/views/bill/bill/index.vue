  ...
  <div class="app-container" ref="appcontainer">
    ...
    <el-date-picker
      ...
      <el-table v-loading="loading" border :data="roleList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="名称" prop="name" align="center" :show-overflow-tooltip="true" width="150" />
        <el-table-column prop="type" label="收支" align="center"  width="150">
        ...
        <el-table-column label="金额" prop="money" align="center" :show-overflow-tooltip="true" width="150"/>
          ...
          <el-row>
             <el-col :span="24">
              <el-form-item label="名称" style="width: 90%" prop="name">
                <el-select v-model="form.name" placeholder="请选择" style="width: 100%" @input="handleBillTypeName" >
                  <el-option
                    v-for="item in Bill_type_name"
                    :key="item.name"
                    :label="item.name"
            ...
            <el-col :span="24">
              <el-form-item label="收支分类" style="width: 90%" prop="author_id">
                <el-select v-model="form.type" placeholder="请选择" style="width: 100%" @input="handleBillType" >
                  <el-option
                    v-for="item in Bill_type_arr"
                    :key="item.id"
                    :label="item.name"
            ...
            <el-col :span="24">
              <el-form-item label="金额" prop="money" style="width: 90%">
                <el-input v-model="form.money" placeholder="请输入账单名称" />
              </el-form-item>
            </el-col>
             <el-col :span="24">
              <el-form-item label="账单详情" prop="content" style="width: 90%">
                <el-input v-model="form.content"  type="textarea" placeholder="请输入诗简介" />
              </el-form-item>
            </el-col>
...
<script>
import { getBilllist, getBillInfo, addBill, updateBill,delBill,getMoney } from '@/api/bill/bill'
 ...
 updated(){
  ...
  methods: {
    ...
    getList() {
      ...
      getBilllist(this.queryParams).then(
        response => {
