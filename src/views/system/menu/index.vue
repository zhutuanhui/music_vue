      ...
      <el-form :inline="true">
        ...
        <el-form-item>
          ...
          <!-- <el-button
            ...
            @click="handleAdd"
          >新增</el-button> -->
          <el-button v-show="true" type="primary" size="mini" icon="el-icon-plus" @click="handleAdd">新增</el-button>
        </el-form-item>
      </el-form>
      ...
      >
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="180">
          <template slot-scope="scope">
            ...
            <el-button v-show="true" type="text" size="mini" icon="el-icon-edit" @click="handleUpdate(scope.row)">编辑</el-button>
            <el-button v-show="true" type="text" size="mini" icon="el-icon-plus" @click="handleAdd(scope.row)">新增</el-button>
            <el-button v-show="true" type="danger" size="mini" @click="handleDelete(scope.row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
  ...
  methods: {
    ...
    submitForm: function() {
      this.$refs['form'].validate(valid => {
        if (valid) {
          if (this.form.menuId !== undefined && this.form.menuId !== 0) {
